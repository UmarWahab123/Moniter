                ...
                <div class="col-12 mt-5">
                    ...
                    <ul class="nav nav-pills mb-3" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active cpu-usage-tab" id="cpu-usage-tab" data-toggle="tab" href="#cpu_usage" role="tab" aria-controls="cpu_usage" aria-selected="true">CPU USAGE</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link ram-usage-tab" id="ram-usage-tab" data-toggle="tab" href="#ram_usage" role="tab" aria-controls="ram_usage" aria-selected="false">RAM USAGE</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link disk_usage-tab" id="disk_usage-tab" data-toggle="tab" href="#disk_usage" role="tab" aria-controls="disk_usage" aria-selected="false">DISK USAGE</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link os-release-tab" id="os-release-tab" data-toggle="tab" href="#os_release" role="tab" aria-controls="os_release" aria-selected="false">OS RELEASE</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link total-users-tab" id="total-users-tab" data-toggle="tab" href="#total_users" role="tab" aria-controls="total_users" aria-selected="false">TOTAL USERS</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="cpu_usage" role="tabpanel" aria-labelledby="cpu-usage-tab">
                            <div class="card">
                                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs mt-3" id="myTab1" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active ram-memory-tab" id="ram-memory-tab" data-toggle="tab" href="#ram_memory" role="tab" aria-controls="ram_memory" aria-selected="true">MEMORY</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link ram-swap-tab" id="ram-swap-tab" data-toggle="tab" href="#ram_swap" role="tab" aria-controls="ram_swap" aria-selected="false">SWAP</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="myTabContent1">
                                        <div class="tab-pane fade show active" id="ram_memory" role="tabpanel" aria-labelledby="ram-memory-tab">
                                            <div class="card">
                                                <div class="card-body">
                                                    <span class="h5 ">RAM MEMORY LOGS</span>
                                                    <div class="table-responsive mt-3">
                                                        <table id="ram_memory_usage_logs_table" class="table table-stripped text-center">
                                                            <thead>
                                                                <tr>
                                                                    <th>#</th>
                                                                    <th>Total</th>
                                        ...
                                        <div class="tab-pane fade" id="ram_swap" role="tabpanel" aria-labelledby="ram-swap-tab">
                                            <div class="card">
                                                <div class="card-body">
                                                    <span class="h5 ">RAM SWAP LOGS</span>
                                                    <div class="table-responsive mt-3">
                                                        <table id="ram_swap_usage_logs_table" class="table table-stripped text-center">
                                                            <thead>
                                                                <tr>
                                                                    <th>#</th>
                                                                    <th>Total</th>
                        ...
                        <div class="tab-pane fade" id="total_users" role="tabpanel" aria-labelledby="os-release-tab">
                            <div class="card">
                                <div class="card-body">
        ...
        if ( !($.fn.dataTable.isDataTable('#cpu_usage_logs_table')) ) {
            var table = $('#cpu_usage_logs_table').DataTable({
                ...
                ajax: {
                    ...
                    data: {server_id:server_id,for_type:for_type},
                    {{-- beforeSend:function()
                    {
                    },
                    success:function()
                ...
                columns: [
                    ...
                    { data: 'iowait', name: 'iowait' },
                    { data: 'steal', name: 'steal' },
                    { data: 'idle', name: 'idle' },
        ...
        if ( !($.fn.dataTable.isDataTable('#disk_usage_logs_table')) ) {
            var table = $('#disk_usage_logs_table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'used_percentage', name: 'used_percentage' },
                    { data: 'created_at', name: 'created_at' },
                ],
            });
        }
    ...
    function get_ram_memory_usage_logs(){
        ...
        if ( !($.fn.dataTable.isDataTable('#ram_memory_usage_logs_table')) ) {
            var table = $('#ram_memory_usage_logs_table').DataTable({
                ...
                ajax: {
                    url:"{{ url('server-logs-in-details') }}",
                    data: {server_id:server_id,for_type:for_type,for_type_ram:for_type_ram},
                    {{-- beforeSend:function()
                    {
                    },
                    success:function()
                ...
                columns: [
                    ...
                    { data: 'buff_cache', name: 'buff_cache' },
                    { data: 'available', name: 'available' },
                    { data: 'created_at', name: 'created_at' },
                ],
            });
        ...
        if ( !($.fn.dataTable.isDataTable('#os_release_logs_table')) ) {
            var table = $('#os_release_logs_table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'os_release_id', name: 'os_release_id' },
                    { data: 'id_like', name: 'id_like' },
                    { data: 'pretty_name', name: 'pretty_name' },
                    { data: 'version_id', name: 'version_id' },
                    { data: 'home_url', name: 'home_url' },
                    { data: 'support_url', name: 'support_url' },
                    { data: 'bug_report_url', name: 'bug_report_url' },
                    { data: 'privacy_policy_url', name: 'privacy_policy_url' },
                    { data: 'version_codename', name: 'version_codename' },
                    { data: 'ubuntu_codename', name: 'ubuntu_codename' },
                ],
            });
        }
        else
