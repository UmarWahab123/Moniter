                    ...
                    <div class="sales-report-area sales-style-two pt-2">
                        <div class="row">
                            @foreach ($servers as $server)
                                ...
                                @endphp
                                <a href="{{ route('server-logs', [$server->id]) }}"
                                    ...
                                    <div class="single-report">
                                        <div class="s-sale-inner pt--30 mb-3">
                                            ...
                                            <div class=" d-flex justify-content-between mt-2">
                                                ...
                                                <p class="bg-info badge text-white">
                                                    @if ($data != null)
                                                        {{ $data['ram_usage']['memory']['used'] }} /
                                                        {{ $data['ram_usage']['memory']['total'] }}
                                                    @else
                                                        N/A
                                                    @endif
                                                </p>
                                            ...
                                            <div class=" d-flex justify-content-between mt-2">
                                                ...
                                                <p class="bg-success badge text-white ">
                                                    {{ $logs != null && $logs != null ? date('Y-m-d', strtotime($logs->created_at)) : '--' }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
